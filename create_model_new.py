...
m.fit_generator(g,steps_per_epoch=train_len/batch_size,epochs=40,verbose=1,callbacks=[ModelCheckpoint("/home/lapis-15/Desktop/cnn_hand_recognition/models/model_CONVNET_VGG.h5", period=1)],validation_data=(data_test,test_labels),max_q_size=25,workers=1)
#m.fit(data_train, train_labels, epochs=40, batch_size=128, verbose=1, shuffle=True, validation_data=(data_test, test_labels), callbacks=[ModelCheckpoint("/home/lapis-15/Desktop/cnn_hand_recognition/models/model_CONVNET_CNN.h5", period=1)])
# while True:
#     index = raw_input("index 0-499")
#     if index == "":
#         break
